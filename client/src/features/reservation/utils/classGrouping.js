export const extractSubjectPayload = (slot = {}) => {
...
export const extractPrice = (slot = {}) => {
...
export const groupClassSubjects = (classSubjects = []) => {
...
export const countUniqueClasses = (classSubjects = []) =>
  groupClassSubjects(classSubjects).length;
